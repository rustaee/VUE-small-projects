...
import { faBars, faTimes, faHome, faUserAlt, faEnvelope, faSearch, faEnvelopeOpenText, faSpinner, faImages, faFan, faScroll } from '@fortawesome/free-solid-svg-icons'
...
library.add(faBars,faTimes, faHome, faUserAlt, faEnvelope, faSearch,faEnvelopeOpenText, faSpinner, faImages, faFan, faScroll)
createApp(App)
  .use(store)
  .use(router)
